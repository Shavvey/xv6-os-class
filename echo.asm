...
main(int argc, char *argv[])
{
  ...
  1c:	7e 43                	jle    61 <main+0x61>
  1e:	bb 01 00 00 00       	mov    $0x1,%ebx
  23:	eb 1b                	jmp    40 <main+0x40>
  25:	8d 76 00             	lea    0x0(%esi),%esi
    printf(1, "%s%s", argv[i], i+1 < argc ? " " : "\n");
  28:	68 f3 07 00 00       	push   $0x7f3
  2d:	ff 74 9e fc          	pushl  -0x4(%esi,%ebx,4)
  31:	68 f5 07 00 00       	push   $0x7f5
  36:	6a 01                	push   $0x1
  38:	e8 f3 03 00 00       	call   430 <printf>
  3d:	83 c4 10             	add    $0x10,%esp
  40:	83 c3 01             	add    $0x1,%ebx
  43:	39 fb                	cmp    %edi,%ebx
  45:	75 e1                	jne    28 <main+0x28>
  47:	83 eb 01             	sub    $0x1,%ebx
  4a:	68 fa 07 00 00       	push   $0x7fa
  4f:	ff 34 9e             	pushl  (%esi,%ebx,4)
  52:	68 f5 07 00 00       	push   $0x7f5
  57:	6a 01                	push   $0x1
  59:	e8 d2 03 00 00       	call   430 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c5:	f7 f1                	div    %ecx
 3c7:	0f b6 92 03 08 00 00 	movzbl 0x803(%edx),%edx
  }while((x /= base) != 0);
 3ce:	85 c0                	test   %eax,%eax
  ...
  do{
    buf[i++] = digits[x % base];
 3d0:	88 14 1e             	mov    %dl,(%esi,%ebx,1)
  }while((x /= base) != 0);
 3d3:	75 eb                	jne    3c0 <printint+0x30>
  if(neg)
 3d5:	8b 55 c4             	mov    -0x3c(%ebp),%edx
    x = xx;
  }
 ...
 3e6:	8d 5c 1d d7          	lea    -0x29(%ebp,%ebx,1),%ebx
...
putc(int fd, char c)
{
 ...
 421:	eb 93                	jmp    3b6 <printint+0x26>
...
printf(int fd, char *fmt, ...)
{
 ...
 44f:	75 38                	jne    489 <printf+0x59>
 451:	e9 b2 00 00 00       	jmp    508 <printf+0xd8>
 456:	8d 76 00             	lea    0x0(%esi),%esi
 459:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
 460:	83 fa 25             	cmp    $0x25,%edx
 463:	0f 84 a7 00 00 00    	je     510 <printf+0xe0>
#include "user.h"
...
putc(int fd, char c)
{
 ...
 493:	83 ff 25             	cmp    $0x25,%edi
 496:	75 e6                	jne    47e <printf+0x4e>
      if(c == 'd'){
 498:	83 fa 64             	cmp    $0x64,%edx
 49b:	0f 84 17 01 00 00    	je     5b8 <printf+0x188>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 4a1:	25 f7 00 00 00       	and    $0xf7,%eax
 4a6:	83 f8 70             	cmp    $0x70,%eax
 4a9:	74 75                	je     520 <printf+0xf0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 4ab:	83 fa 73             	cmp    $0x73,%edx
 4ae:	0f 84 9c 00 00 00    	je     550 <printf+0x120>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 4b4:	83 fa 63             	cmp    $0x63,%edx
 4b7:	0f 84 0a 01 00 00    	je     5c7 <printf+0x197>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 4bd:	83 fa 25             	cmp    $0x25,%edx
 4c0:	0f 84 da 00 00 00    	je     5a0 <printf+0x170>
#include "user.h"
...
{
  write(fd, &c, 1);
 4c6:	8d 45 e6             	lea    -0x1a(%ebp),%eax
 4c9:	83 ec 04             	sub    $0x4,%esp
 4cc:	89 55 d0             	mov    %edx,-0x30(%ebp)
 4cf:	6a 01                	push   $0x1
 4d1:	c6 45 e6 25          	movb   $0x25,-0x1a(%ebp)
 4d5:	50                   	push   %eax
 4d6:	56                   	push   %esi
 4d7:	e8 f6 fd ff ff       	call   2d2 <write>
      } else if(c == '%'){
        putc(fd, c);
      } else {
...
putc(int fd, char c)
{
 ...
 4f1:	e8 dc fd ff ff       	call   2d2 <write>
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
 4f6:	0f b6 53 ff          	movzbl -0x1(%ebx),%edx
#include "user.h"
...
putc(int fd, char c)
{
 ...
 515:	e9 64 ff ff ff       	jmp    47e <printf+0x4e>
 ...
 531:	e8 5a fe ff ff       	call   390 <printint>
        ap++;
 ...
 543:	e9 36 ff ff ff       	jmp    47e <printf+0x4e>
 548:	90                   	nop
 549:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      } else if(c == 's'){
        s = (char*)*ap;
 550:	8b 45 d4             	mov    -0x2c(%ebp),%eax
 553:	8b 38                	mov    (%eax),%edi
        ap++;
 555:	83 c0 04             	add    $0x4,%eax
 558:	89 45 d4             	mov    %eax,-0x2c(%ebp)
        if(s == 0)
 55b:	85 ff                	test   %edi,%edi
 55d:	0f 84 80 00 00 00    	je     5e3 <printf+0x1b3>
          s = "(null)";
        while(*s != 0){
 563:	0f b6 07             	movzbl (%edi),%eax
 566:	84 c0                	test   %al,%al
 568:	74 25                	je     58f <printf+0x15f>
...
putc(int fd, char c)
{
 ...
 58d:	75 e1                	jne    570 <printf+0x140>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
 ...
 591:	e9 e8 fe ff ff       	jmp    47e <printf+0x4e>
...
putc(int fd, char c)
{
 ...
 5a3:	c6 45 e5 25          	movb   $0x25,-0x1b(%ebp)
 5a7:	8d 45 e5             	lea    -0x1b(%ebp),%eax
 5aa:	6a 01                	push   $0x1
 5ac:	e9 39 ff ff ff       	jmp    4ea <printf+0xba>
 ...
 5c0:	6a 01                	push   $0x1
 5c2:	e9 63 ff ff ff       	jmp    52a <printf+0xfa>
        while(*s != 0){
          putc(fd, *s);
          s++;
        }
...
putc(int fd, char c)
{
 ...
 5d7:	50                   	push   %eax
 5d8:	56                   	push   %esi
 5d9:	e8 f4 fc ff ff       	call   2d2 <write>
 5de:	e9 53 ff ff ff       	jmp    536 <printf+0x106>
        ap++;
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
          s = "(null)";
 5e3:	bf fc 07 00 00       	mov    $0x7fc,%edi
 5e8:	e9 76 ff ff ff       	jmp    563 <printf+0x133>
...
free(void *ap)
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 14 0b 00 00       	mov    %eax,0xb14
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
...
free(void *ap)
{
 ...
 663:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 666:	a3 14 0b 00 00       	mov    %eax,0xb14
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6ac:	8d 1c f5 00 00 00 00 	lea    0x0(,%esi,8),%ebx
 6b3:	eb 0c                	jmp    6c1 <malloc+0x41>
 ...
 6bf:	76 4f                	jbe    710 <malloc+0x90>
    ...
    if(p == freep)
 6c1:	3b 05 14 0b 00 00    	cmp    0xb14,%eax
 6c7:	89 c2                	mov    %eax,%edx
 6c9:	75 ed                	jne    6b8 <malloc+0x38>
morecore(uint nu)
{
  char *p;
  Header *hp;
 ...
 6d1:	77 5d                	ja     730 <malloc+0xb0>
 6d3:	b8 00 80 00 00       	mov    $0x8000,%eax
    nu = 4096;
 6d8:	bf 00 10 00 00       	mov    $0x1000,%edi
  p = sbrk(nu * sizeof(Header));
 6dd:	83 ec 0c             	sub    $0xc,%esp
 6e0:	50                   	push   %eax
 6e1:	e8 54 fc ff ff       	call   33a <sbrk>
  if(p == (char*)-1)
 6e6:	83 c4 10             	add    $0x10,%esp
 6e9:	83 f8 ff             	cmp    $0xffffffff,%eax
 6ec:	74 1c                	je     70a <malloc+0x8a>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 6f8:	e8 f3 fe ff ff       	call   5f0 <free>
  return freep;
 6fd:	8b 15 14 0b 00 00    	mov    0xb14,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 708:	75 ae                	jne    6b8 <malloc+0x38>
        return 0;
 70a:	31 c0                	xor    %eax,%eax
 70c:	eb 1a                	jmp    728 <malloc+0xa8>
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
 730:	89 d8                	mov    %ebx,%eax
 732:	89 f7                	mov    %esi,%edi
 734:	eb a7                	jmp    6dd <malloc+0x5d>
 ...
 744:	eb d9                	jmp    71f <malloc+0x9f>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 746:	c7 05 14 0b 00 00 18 	movl   $0xb18,0xb14
 74d:	0b 00 00 
 750:	c7 05 18 0b 00 00 18 	movl   $0xb18,0xb18
 757:	0b 00 00 
    base.s.size = 0;
 75a:	b8 18 0b 00 00       	mov    $0xb18,%eax
 75f:	c7 05 1c 0b 00 00 00 	movl   $0x0,0xb1c
 766:	00 00 00 
...
int lock_init(struct lock_t *lk) { 
 ...
 778:	74 0d                	je     787 <lock_init+0x17>
    lk->lock = 0;
 77a:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return 1;
...
static inline uint __xchg(uint* lock) {
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
 79d:	f0 87 03             	lock xchg %eax,(%ebx)
  }
}
...
static inline uint __xchg(uint* lock) {
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
 7a2:	be 01 00 00 00       	mov    $0x1,%esi
  }
}
...
int lock_acquire(struct lock_t *lk) {
  // use set and test to see if mutex lock is available
  while (__xchg(&lk->lock)) {
 7a7:	74 1d                	je     7c6 <lock_acquire+0x36>
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    // use sleep to yield to the scheduler
    sleep(1);
 7b0:	83 ec 0c             	sub    $0xc,%esp
 7b3:	6a 01                	push   $0x1
 7b5:	e8 88 fb ff ff       	call   342 <sleep>
...
static inline uint __xchg(uint* lock) {
 ...
 7bc:	f0 87 03             	lock xchg %eax,(%ebx)
  }
}
...
int lock_acquire(struct lock_t *lk) {
 ...
 7c4:	75 ea                	jne    7b0 <lock_acquire+0x20>
    // use sleep to yield to the scheduler
    sleep(1);
  }
  return 1;
