...
printint(int fd, int xx, int base, int sgn)
{
 ...
 465:	f7 f1                	div    %ecx
 467:	0f b6 92 d2 08 00 00 	movzbl 0x8d2(%edx),%edx
  }while((x /= base) != 0);
 46e:	85 c0                	test   %eax,%eax
  ...
  do{
    buf[i++] = digits[x % base];
 470:	88 14 1e             	mov    %dl,(%esi,%ebx,1)
  }while((x /= base) != 0);
 473:	75 eb                	jne    460 <printint+0x30>
  if(neg)
 475:	8b 55 c4             	mov    -0x3c(%ebp),%edx
    x = xx;
  }
 ...
 486:	8d 5c 1d d7          	lea    -0x29(%ebp,%ebx,1),%ebx
...
putc(int fd, char c)
{
 ...
 4b8:	89 d0                	mov    %edx,%eax
  ...
  neg = 0;
 4ba:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
 4c1:	eb 93                	jmp    456 <printint+0x26>
...
printf(int fd, char *fmt, ...)
{
 ...
 4ef:	75 38                	jne    529 <printf+0x59>
 4f1:	e9 b2 00 00 00       	jmp    5a8 <printf+0xd8>
 4f6:	8d 76 00             	lea    0x0(%esi),%esi
 4f9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
 500:	83 fa 25             	cmp    $0x25,%edx
...
putc(int fd, char c)
{
 ...
 514:	50                   	push   %eax
 515:	56                   	push   %esi
 516:	e8 57 fe ff ff       	call   372 <write>
 ...
 527:	74 7f                	je     5a8 <printf+0xd8>
    c = fmt[i] & 0xff;
    if(state == 0){
 529:	85 ff                	test   %edi,%edi
  uint *ap;
  ...
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
 52b:	0f be c2             	movsbl %dl,%eax
 52e:	0f b6 d2             	movzbl %dl,%edx
    if(state == 0){
 ...
 533:	83 ff 25             	cmp    $0x25,%edi
 536:	75 e6                	jne    51e <printf+0x4e>
      if(c == 'd'){
 538:	83 fa 64             	cmp    $0x64,%edx
 53b:	0f 84 17 01 00 00    	je     658 <printf+0x188>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 541:	25 f7 00 00 00       	and    $0xf7,%eax
 546:	83 f8 70             	cmp    $0x70,%eax
 549:	74 75                	je     5c0 <printf+0xf0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 54b:	83 fa 73             	cmp    $0x73,%edx
 54e:	0f 84 9c 00 00 00    	je     5f0 <printf+0x120>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 554:	83 fa 63             	cmp    $0x63,%edx
 557:	0f 84 0a 01 00 00    	je     667 <printf+0x197>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 55d:	83 fa 25             	cmp    $0x25,%edx
 560:	0f 84 da 00 00 00    	je     640 <printf+0x170>
#include "user.h"
...
putc(int fd, char c)
{
 ...
 56c:	89 55 d0             	mov    %edx,-0x30(%ebp)
 56f:	6a 01                	push   $0x1
 571:	c6 45 e6 25          	movb   $0x25,-0x1a(%ebp)
 575:	50                   	push   %eax
 576:	56                   	push   %esi
 577:	e8 f6 fd ff ff       	call   372 <write>
      } else if(c == '%'){
        putc(fd, c);
      } else {
...
putc(int fd, char c)
{
 ...
 591:	e8 dc fd ff ff       	call   372 <write>
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
 596:	0f b6 53 ff          	movzbl -0x1(%ebx),%edx
#include "user.h"
...
putc(int fd, char c)
{
 ...
 5b5:	e9 64 ff ff ff       	jmp    51e <printf+0x4e>
 ...
 5c8:	6a 00                	push   $0x0
 5ca:	8b 7d d4             	mov    -0x2c(%ebp),%edi
 5cd:	89 f0                	mov    %esi,%eax
 5cf:	8b 17                	mov    (%edi),%edx
 5d1:	e8 5a fe ff ff       	call   430 <printint>
        ap++;
...
putc(int fd, char c)
{
 ...
 62d:	75 e1                	jne    610 <printf+0x140>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
 ...
 631:	e9 e8 fe ff ff       	jmp    51e <printf+0x4e>
...
putc(int fd, char c)
{
 ...
 643:	c6 45 e5 25          	movb   $0x25,-0x1b(%ebp)
 647:	8d 45 e5             	lea    -0x1b(%ebp),%eax
 64a:	6a 01                	push   $0x1
 64c:	e9 39 ff ff ff       	jmp    58a <printf+0xba>
 ...
 660:	6a 01                	push   $0x1
 662:	e9 63 ff ff ff       	jmp    5ca <printf+0xfa>
        while(*s != 0){
          putc(fd, *s);
          s++;
        }
...
putc(int fd, char c)
{
 ...
 677:	50                   	push   %eax
 678:	56                   	push   %esi
 679:	e8 f4 fc ff ff       	call   372 <write>
 67e:	e9 53 ff ff ff       	jmp    5d6 <printf+0x106>
        ap++;
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
          s = "(null)";
 683:	bf cb 08 00 00       	mov    $0x8cb,%edi
 688:	e9 76 ff ff ff       	jmp    603 <printf+0x133>
...
free(void *ap)
{
 ...
 691:	a1 40 0c 00 00       	mov    0xc40,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6bc:	39 d7                	cmp    %edx,%edi
 6be:	74 2c                	je     6ec <free+0x5c>
 ...
 6cd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6cf:	a3 40 0c 00 00       	mov    %eax,0xc40
}
 6d4:	5b                   	pop    %ebx
 6d5:	5e                   	pop    %esi
 6d6:	5f                   	pop    %edi
...
free(void *ap)
{
 ...
 703:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 706:	a3 40 0c 00 00       	mov    %eax,0xc40
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 40 0c 00 00    	mov    0xc40,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 74c:	8d 1c f5 00 00 00 00 	lea    0x0(,%esi,8),%ebx
 753:	eb 0c                	jmp    761 <malloc+0x41>
 ...
 75f:	76 4f                	jbe    7b0 <malloc+0x90>
    ...
    if(p == freep)
 761:	3b 05 40 0c 00 00    	cmp    0xc40,%eax
 767:	89 c2                	mov    %eax,%edx
 769:	75 ed                	jne    758 <malloc+0x38>
morecore(uint nu)
{
  char *p;
  Header *hp;
  ...
  if(nu < 4096)
 76b:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
 771:	77 5d                	ja     7d0 <malloc+0xb0>
 773:	b8 00 80 00 00       	mov    $0x8000,%eax
    nu = 4096;
 778:	bf 00 10 00 00       	mov    $0x1000,%edi
  p = sbrk(nu * sizeof(Header));
 77d:	83 ec 0c             	sub    $0xc,%esp
 780:	50                   	push   %eax
 781:	e8 54 fc ff ff       	call   3da <sbrk>
  if(p == (char*)-1)
 786:	83 c4 10             	add    $0x10,%esp
 789:	83 f8 ff             	cmp    $0xffffffff,%eax
 78c:	74 1c                	je     7aa <malloc+0x8a>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 797:	50                   	push   %eax
 798:	e8 f3 fe ff ff       	call   690 <free>
  return freep;
 79d:	8b 15 40 0c 00 00    	mov    0xc40,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7a8:	75 ae                	jne    758 <malloc+0x38>
        return 0;
 7aa:	31 c0                	xor    %eax,%eax
 7ac:	eb 1a                	jmp    7c8 <malloc+0xa8>
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 7bf:	89 15 40 0c 00 00    	mov    %edx,0xc40
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 7d2:	89 f7                	mov    %esi,%edi
 7d4:	eb a7                	jmp    77d <malloc+0x5d>
 ...
 7e4:	eb d9                	jmp    7bf <malloc+0x9f>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7e6:	c7 05 40 0c 00 00 44 	movl   $0xc44,0xc40
 7ed:	0c 00 00 
 7f0:	c7 05 44 0c 00 00 44 	movl   $0xc44,0xc44
 7f7:	0c 00 00 
    base.s.size = 0;
 7fa:	b8 44 0c 00 00       	mov    $0xc44,%eax
 7ff:	c7 05 48 0c 00 00 00 	movl   $0x0,0xc48
 806:	00 00 00 
...
int lock_init(struct lock_t *lk) { 
 ...
 818:	74 0d                	je     827 <lock_init+0x17>
    lk->lock = 0;
 81a:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return 1;
 ...
 826:	c3                   	ret    
  if (lk) {
    ...
    // just return an error, if lock ref is null
    return -1; 
 827:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  }
}
 82c:	5d                   	pop    %ebp
 82d:	c3                   	ret    
...
static inline uint __xchg(uint* lock) {
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
 83d:	f0 87 03             	lock xchg %eax,(%ebx)
  }
}
...
static inline uint __xchg(uint* lock) {
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
 842:	be 01 00 00 00       	mov    $0x1,%esi
  }
}
...
static inline uint __xchg(uint* lock) {
 ...
 85c:	f0 87 03             	lock xchg %eax,(%ebx)
  }
}
...
int lock_acquire(struct lock_t *lk) {
 ...
 864:	75 ea                	jne    850 <lock_acquire+0x20>
    // use sleep to yield to the scheduler
    sleep(1);
  }
  return 1;
