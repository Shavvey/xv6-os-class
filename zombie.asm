...
printint(int fd, int xx, int base, int sgn)
{
 ...
 385:	f7 f1                	div    %ecx
 387:	0f b6 92 ba 07 00 00 	movzbl 0x7ba(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 59e:	e9 53 ff ff ff       	jmp    4f6 <printf+0x106>
        ...
        if(s == 0)
          s = "(null)";
 5a3:	bf b3 07 00 00       	mov    $0x7b3,%edi
...
free(void *ap)
{
 ...
 5b1:	a1 c0 0a 00 00       	mov    0xac0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ef:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 5f4:	5b                   	pop    %ebx
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
...
free(void *ap)
{
 ...
 623:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 626:	a3 c0 0a 00 00       	mov    %eax,0xac0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 c0 0a 00 00    	mov    0xac0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 67f:	76 4f                	jbe    6d0 <malloc+0x90>
    ...
    if(p == freep)
 681:	3b 05 c0 0a 00 00    	cmp    0xac0,%eax
...
morecore(uint nu)
{
 ...
 6b8:	e8 f3 fe ff ff       	call   5b0 <free>
  return freep;
 6bd:	8b 15 c0 0a 00 00    	mov    0xac0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6dc:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 6df:	89 15 c0 0a 00 00    	mov    %edx,0xac0
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 704:	eb d9                	jmp    6df <malloc+0x9f>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 706:	c7 05 c0 0a 00 00 c4 	movl   $0xac4,0xac0
 70d:	0a 00 00 
 710:	c7 05 c4 0a 00 00 c4 	movl   $0xac4,0xac4
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 c4 0a 00 00       	mov    $0xac4,%eax
 71f:	c7 05 c8 0a 00 00 00 	movl   $0x0,0xac8
 726:	00 00 00 
