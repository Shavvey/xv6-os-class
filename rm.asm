...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d5:	f7 f1                	div    %ecx
 3d7:	0f b6 92 37 08 00 00 	movzbl 0x837(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5ee:	e9 53 ff ff ff       	jmp    546 <printf+0x106>
        ...
        if(s == 0)
          s = "(null)";
 5f3:	bf 30 08 00 00       	mov    $0x830,%edi
...
free(void *ap)
{
 ...
 601:	a1 48 0b 00 00       	mov    0xb48,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 48 0b 00 00       	mov    %eax,0xb48
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
...
free(void *ap)
{
 ...
 673:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 676:	a3 48 0b 00 00       	mov    %eax,0xb48
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 48 0b 00 00    	mov    0xb48,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6cf:	76 4f                	jbe    720 <malloc+0x90>
    ...
    if(p == freep)
 6d1:	3b 05 48 0b 00 00    	cmp    0xb48,%eax
...
morecore(uint nu)
{
 ...
 708:	e8 f3 fe ff ff       	call   600 <free>
  return freep;
 70d:	8b 15 48 0b 00 00    	mov    0xb48,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 72c:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 72f:	89 15 48 0b 00 00    	mov    %edx,0xb48
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 754:	eb d9                	jmp    72f <malloc+0x9f>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 756:	c7 05 48 0b 00 00 4c 	movl   $0xb4c,0xb48
 75d:	0b 00 00 
 760:	c7 05 4c 0b 00 00 4c 	movl   $0xb4c,0xb4c
 767:	0b 00 00 
    base.s.size = 0;
 76a:	b8 4c 0b 00 00       	mov    $0xb4c,%eax
 76f:	c7 05 50 0b 00 00 00 	movl   $0x0,0xb50
 776:	00 00 00 
